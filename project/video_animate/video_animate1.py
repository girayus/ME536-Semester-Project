...
rect = plt.Rectangle((0.5, 0.5), 0.75, 1.5, fc='r')
rect1 = plt.Rectangle((1.25, 0.5), 0.75, 1.5, fc='b')
plt.axis('off')
...
def animationManage(i,circ,rect,rect1):
    animate2D(i,circ)
    animate1D(i,rect)
    animate11D(i,rect1)
    return []
...
def animate11D(i, patch):
    if i <= 120:
        ...
        patch.set_x(1.25 + 0.07*(i-240))#patch.set_y(8.9 - 0.07*(i-240))
    else:
        pass#patch.set_x(8.9 - 0.07*(i-360))
    return patch,
